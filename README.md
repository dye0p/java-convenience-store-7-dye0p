...
- [x] 멤버십 할인을 하는 기능
    - [x] 멤버십 할인의 최대 한도를 8000원으로 제한하는 기능
- [x] 사용자가 입력한 상품의 가격과 수량을 기반으로 최종 결제 금액을 계산하는 기능
    - [x] 사용자가 입력한 상품의 가격과 수량을 기반으로 최종 결제 금액을 계산하는 기능
    - [x] 상품별 가격과 수량을 곱하여 총구매액을 계산하는 기능
    - [x] 프로모션 및 멤버십 할인 정책을 반영하여 최종 결제 금액을 산출하는 기능
- [x] 추가 구매할 수 있는 기능
- [x] 사용자가 잘못된 값을 입력할 경우 `IllegalArgumentException`를 발생시키고, "[ERROR]"로 시작하는 에러 메시지를 출력 후 그 부분부터 입력을 다시 받는 기능
...
- [x] "[ERROR]"로 시작하는 오류 메시지와 함께 상황에 맞는 안내를 출력 하는 기능
...
3. 사용자가 입력한 상품의 가격과 수량을 기반으로 최종 결제 금액을 계산한다.
